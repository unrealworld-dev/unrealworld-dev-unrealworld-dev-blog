		...
		<div className="mt-12 w-full px-4 sm:px-6 lg:px-8">
			<div className="mb-8 text-center" style={{ fontFamily: 'Dunggeunmo' }}>
				<p className={`text-4xl`}>
					📚 <span className={` font-semibold bg-gradient-to-r from-indigo-500 via-pink-500 to-yellow-500 bg-clip-text text-transparent ${style["animate-gradient-text"]}`}>Category List</span>
				</p>
