...
export default function PostCardDetail({ post }: { post: PostItem }) {


	return (
		<div className="bg-[--background] border border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col h-full">
